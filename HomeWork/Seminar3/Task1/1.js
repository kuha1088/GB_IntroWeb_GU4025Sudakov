...
function convertTemperature(convertingTemperature) {
    return (9 / 5) * convertingTemperature + 32;
}

const userTemperature = Number.parseFloat(prompt('Введите температуру в градусах Цельсия: ')).toFixed(1);
alert(`Цельсий: ${userTemperature}, Фаренгейт: ${convertTemperature(userTemperature)}`);